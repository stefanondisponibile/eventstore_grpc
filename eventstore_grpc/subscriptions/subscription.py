...
class Subscription(threading.Thread):
    ...
    def __init__(self, requests_stream: RequestsStream, stub = None, manager = None, name = None, **kwargs):
    ...
    def run(self, *args, **kwargs):
        ...
        try:
            ...
            if err.code() == grpc.StatusCode.CANCELLED:
                ...
                print(f"\033[38;5;209m[REVOKING SUBSCRIPTION {self.name}]: {err.code()} - {err.details()}\033[0m")
